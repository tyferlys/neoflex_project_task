...
from includes.constant import metadata_dag_etl_rd_deal_info as metadata
...
def process_task(**kwargs):
    ...
    load_data_to_db(df, metadata, True, "project2-neoflex")
...
with DAG(
        "etl_rd_deal_info",
        default_args={},
        description="Загрузка deal_info",
